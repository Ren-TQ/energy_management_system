package com.campus.energy.exception;
...
/**
 * ============================================
 * 分层架构 - 横切关注点层（Cross-Cutting Concerns Layer）
 * ============================================
 * 
 * 架构说明：
 * 本类属于横切关注点架构层，负责全局异常处理
 * 
 * 横切关注点架构特点：
 * - 跨越多个业务层的功能
 * - 使用AOP（面向切面编程）思想
 ...
 * - 全局异常捕获和处理
 * - 统一错误响应格式
 * - 异常分类处理（业务异常、参数校验异常、认证异常等）
 * 
 * 架构位置：
 * - 位于所有业务层之上
 * - 拦截Controller层抛出的所有异常
 * - 返回统一的Result格式
 * 
 * 数据流转：
 * Controller → 抛出异常 → GlobalExceptionHandler → 统一错误响应
 * ============================================
 * 
 * 全局异常处理器
 */
